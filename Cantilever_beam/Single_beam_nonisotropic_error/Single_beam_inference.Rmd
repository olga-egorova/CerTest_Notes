...
```{r}
# Load the FE model
source_python("/Users/olga/work/CerTest/pyComp/examples/cantilever_data.py")
...
df_data = df_data[c(1:2,4:5,8,10),]    # choose a subset of data points
```
...
```
Same for the model without the discrepancy term:
```{r}
