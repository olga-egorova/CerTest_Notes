---
title: "Cantilever beam modelling: single beam "
author: "Olga Egorova"
...
Picking the "true" theta-s (chooising at random in the region $[-\pi/30, \pi/30]$), running the FE model and saving the displacements.
...
coords_ind = c(6, 72, 101, 870, 1223, 2237, 2333, 2610, 2739, 2803)
...
sim_ind = c(46, 53, 73, 134, 163, 254, 345, 435, 462, 562, 591, 666, 673, 715, 749, 767, 775, 1428, 1472, 1544, 
            1699, 1705, 1722, 1740, 1904, 1949, 2032, 2154, 2196, 2203)
...
xf = dt_data[,1:p]                  # observed (controllable) input
...
# MC traceplots, excluding warm-up
...
Run model without the discrepancy term: $y(x) = \eta(x,t) + \varepsilon$.
...
```{r}
df_of_draws0 = as.data.table(fit0)              
...
An idea: possibility for visualisation -- using the "shinystan" library.
```{r}
# library(shinystan)
